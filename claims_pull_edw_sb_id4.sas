...
/*						   	   ,A.QL_CLNT_ID AS QL_CLIENT_ID*/
	...
	*/
/* New logic to fix client_level issue for RX Horizon*/
			%LET CLIENT_TABLE = %STR(&DSS_CLIN..V_ALGN_LVL_DENORM CLT);  
			...
			%LET CLIENT_VARS = %STR(,CLT.ALGN_LVL_GID_KEY 
						...
						%IF CLT.EXTNL_LVL_ID1 EQ '7021'
									,CLT.EXTNL_LVL_ID3 || CLT.EXTNL_LVL_ID4 AS CLIENT_LEVEL_3 );
						%ELSE %DO
									,CLT.EXTNL_LVL_ID3 AS CLIENT_LEVEL_3 );
						%END;
			%END;
			...
			%END;
/* end new logic for client_level issue for RX Horizon*/
