...
+------------------------------------------------------------------------SASDOC*;
%MACRO CLAIMS_PULL_EDW_CLTDRG_24MAR2009(CLIENT_DRUG_TABLE_RX = &ORA_TMP..EXT_CLIENT_DRUG_TABLE_RX,
					                   CLIENT_DRUG_TABLE_RE = &ORA_TMP..EXT_CLIENT_DRUG_TABLE_RE);
...
/*	Apply pharmacy_id business rules here MOR claims  */
...
%MEND CLAIMS_PULL_EDW_CLTDRG_24MAR2009;
