...
%LET NEW_ADD_BASE_COLUMNS=%STR( MAX(E.RX_NB) AS RX_NB,
         SUM(E.DISPENSED_QY) AS DISPENSED_QY,
         SUM(E.DAY_SUPPLY_QY) AS DAY_SUPPLY_QY,
         MAX(E.GPI_THERA_CLS_CD) AS GPI_THERA_CLS_CD,
         MAX(E.BRAND_GENERIC) AS BRAND_GENERIC,
         MAX(E.PHARMACY_NM) AS PHARMACY_NM,
         SUM(E.REFILL_FILL_QY) AS REFILL_FILL_QY,
         MAX(E.FORMULARY_TX) AS FORMULARY_TX,
         MAX(E.DEA_NB) AS DEA_NB,
         MAX(E.PRESCRIBER_NPI_NB) AS PRESCRIBER_NPI_NB );
...
PROC SQL NOPRINT;
	...
	(
	  ...
	  SELECT 
		  ...
		  %END;
		  %ELSE %DO;
		  MAX(E.LAST_DELIVERY_SYS) AS LAST_DELIVERY_SYS,/* YM:OCT4,2012 ADDED NEW ELSE STATEMENT */
		  %END;
