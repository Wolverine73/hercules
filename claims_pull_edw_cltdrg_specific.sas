...
%MACRO CLAIMS_PULL_EDW_CLTDRG_SPECIFIC(CLIENT_DRUG_TABLE_RX = &ORA_TMP..EXT_CLIENT_DRUG_TABLE_RX,
					                   CLIENT_DRUG_TABLE_RE = &ORA_TMP..EXT_CLIENT_DRUG_TABLE_RE,
                                       CLM_BEGIN_DT = %STR(1920-01-01),  
                                       CLM_END_DT = %STR(2079-12-31) );
...
%MEND CLAIMS_PULL_EDW_CLTDRG_SPECIFIC;
