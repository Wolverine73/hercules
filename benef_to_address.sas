...
* OPTIONS MLOGIC MPRINT SYMBOLGEN;
 OPTIONS SYSPARM='INITIATIVE_ID=243 PHASE_SEQ_NB=1';
...
CREATE TABLE QCPAP020.APPLIGY_07_04B(BULKLOAD=YES) AS
...
QUIT;
 ...
 %get_moc_csphone(tbl_name_in=QCPAP020.APPLIGY_07_04B, tbl_name_out=QCPAP020.APPLIGY_07_04);
...
Proc sql;
     ...
     select *, 1 as data_quality_cd
     from &table_prefix._&cmctn_role_cd
     WHERE CLIENT_ID NOT IN (&CLIENT_EXLUDE, 142,12515,12175,11366); quit;
...
proc sql noprint;
   ...
   %export_sas_to_txt(tbl_name_in=stats,
      ...
      filename ftp_txt ftp "/users/patientlist/CUSTOM_MAILINGS/mailing/&table_prefix._&cmctn_role_cd.apology_07_04.txt"
            mach='sfb006.psd.caremark.int' RECFM=v ;
