...
|
+----------------------------------------------------------------------HEADER*;
%macro cee_get_data_quality(TBL_NAME_IN=, TBL_NAME_OUT=);
...
+-----------------------------------------------------------------------SASDOC*;
        ...
        from    (
                select distinct  OPPORTUNITY_ID, ZIP_CD, RVR_FIRST_NM, RVR_LAST_NM
...
+-----------------------------------------------------------------------SASDOC*;
        ...
        group by OPPORTUNITY_ID) as B
on      (A.OPPORTUNITY_ID eq B.OPPORTUNITY_ID);
quit;
