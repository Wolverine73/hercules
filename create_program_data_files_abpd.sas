/*HEADER-----------------------------------------------------------------------
|
| PROGRAM:  create_program_data_files_abpd.sas (macro)
|
...
| HISTORY:  
|
| 04MAR2010 - Gregory dudley - Hercules Version  2.5.01
|             Original.  
|

+-----------------------------------------------------------------------HEADER*/ 

%MACRO CREATE_PROGRAM_DATA_FILES_ABPD;

	%LET DALCDCP_LOC = /herc&sysmode/data/hercules/5371/program_data;
...
%MEND CREATE_PROGRAM_DATA_FILES_ABPD;
