...
/*		%LET REFILL_QTY = %STR(,VCLM.ATHZD_REFIL_QTY AS REFILL_FILL_QY);*/									
		...
		%IF %SYSFUNC(EXIST(&ORA_TMP..ALGN_LVL_LIST_16560_RE)) %THEN %DO;
		  %PUT NOTE:  DROP TABLE RECAP CC:  &ORA_TMP..ALGN_LVL_LIST_16560_RE ;
		  %DROP_ORACLE_TABLE(TBL_NAME=&ORA_TMP..ALGN_LVL_LIST_16560_RE);
		%END;
