...
%*SASDOC---------------------------------------------------------------------------------
 |CCW4 : WE CHECK IF CLIENT MIGRATED FROM RE TO RX 
...
%*SASDOC---------------------------------------------------------------------------------
 |CCW4 : IF MIGRATION INDICATOR IS 1
 | 		RUN RECAP MACRO TO CREATE TEMP TABLES FOR MIGRATED CLIENT
 +----------------------------------------------------------------------------SASDOC;
