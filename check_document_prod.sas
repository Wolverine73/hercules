...
/*	AK added - 02Mar2013 - to subset the required tables and decrease run time and 
	solve problems with reading damaged datasets.	*/ 

	PROC SQL;
	CREATE TABLE VTABLE AS
	SELECT * FROM
	SASHELP.VTABLE
	WHERE LIBNAME IN ('DATA_PND','DATA_RES') AND MEMNAME LIKE "CHKDOC_RN_&SYSJOBID._%";
	QUIT;
