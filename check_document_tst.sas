...
*SASDOC -----------------------------------------------------------------------------------
  ...
  +--------------------------------------------------------------------------------SASDOC*;
	...
	%IF &CLIENTVARIABLE. > 0 AND &MODMAIL. NE %THEN %DO;
		...
		%LET CPG_CONS = %STR(AND A.CLIENT_LEVEL_1  = PUT(B.CLT_PLAN_GROUP_ID,20.)
                             );
...
%*SASDOC -----------------------------------------------------------------------
 ...
 +-----------------------------------------------------------------------SASDOC*;
    ...
    %CHK_DOC_CLTID_FIX(ADJ_ENGINE = &ADJ_ENGINE.);
