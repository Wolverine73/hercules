...
PROC SORT DATA=ERR_FILE&I. NODUPKEY ;
  BY PGM_ID ERROR_NBR APN_CMM_ID CMM_GEN_TS RVR_ROLE_CD RVR_ID SBJ_ROLE_CD SBJ_ID DRUG_NDC ;
RUN;
...
*******************************************************************;
 ...
 %IF &I=5 %THEN %DO ;
	...
	filename RPTFL "/DATA/sas&sysmode.1/hercules/gen_utilities/sas/update_cmctn/&APPLICATION._&MTH.&DAY.&YR..PDF";
