...
LIBNAME DATA    "/DATA/sasadhoc1/hercules";
...
FILENAME FMTFL '/DATA/sasadhoc1/hercules/sas_formats/formats.txt';                                         
DATA _NULL_;
   		 MERGE VARFMT(IN = IN1)             
...
DATA FINAL2;
    FORMAT %INCLUDE '/DATA/sasadhoc1/hercules/sas_formats/formats.txt';
RUN;
