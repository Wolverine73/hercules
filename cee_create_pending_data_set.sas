...
|                     TABLE AS INPUT
+-----------------------------------------------------------------------HEADER*/
%MACRO cee_create_pending_data_set(TBL_NAME_IN = ) ;
...
/*SANJESH :COMMENT DIRECTED BY VINOD*****/
/*%include "/PRG/sas%lowcase(&SYSMODE)1/hercules/macros/add_rocc_cd.sas";*/

/*COMMENTS DIRECTED BY VINOD ENDS HERE**********************************/
...
/*SANJESH : COMMENTING FOR THE TIME BEING DIRECTED BY VINOD*/
...
/*SANJESH: ADDING THIS CODING OUT OF IF ELSE  DIRECTED BY VINOD*/
...
%MEND cee_create_pending_data_set;
