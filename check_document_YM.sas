 ...
 *SASDOC -----------------------------------------------------------------------
  ...
  %INCLUDE "/hercdev2/prg/hercules/manual_ins_ovr.sas";
...
/*		YM:Aug24,2012 changed to INPUT for testing of Generic_Brand*/
/*		%LET CPG_CONS = %STR(AND A.CLIENT_LEVEL_1  = B.CLT_PLAN_GROUP_ID*/
...
/** YM Aug24,2012: commented this line "PUT converting to char "for testing Generic_brand,please remove in prod or other programs ;*/
/*Proc sql;*/
/*CREATE table QL_DOC_OVR as */
/*select a.*,CLT_PLAN_GROUP_ID as CLIENT_LEVEL_1*/
/*from QL_DOC_OVR a;*/
/*quit;*/

/*			DATA QL_DOC_OVR;*/
/*			  SET QL_DOC_OVR;*/
/*			   CLIENT_LEVEL_1=LEFT(INPUT(CLT_PLAN_GROUP_ID,20.));*/
/*			RUN;*/
