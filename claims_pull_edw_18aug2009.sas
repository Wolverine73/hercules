...
/*  			LEFT JOIN*/
/*  			     &CLAIMSA..TCLIENT1 B*/
/*  			ON TRIM(LEFT(A.&CARRIER_FIELD.)) = TRIM(LEFT(B.CLIENT_CD));*/
...
/*               and clt.client_level_1=4740*/
  ...
  *SASDOC--------------------------------------------------------------------------
  ...
  /*          AND c.BNFT_LVL_CODE NOT LIKE 'PENCD%'*/
          ;
      quit;
  *SASDOC--------------------------------------------------------------------------
  |18AUG2009 - Hercules Version  2.1.2.02
  ...
  *SASDOC--------------------------------------------------------------------------
  ...
  /*		PROC SQL;*/
  /*			CONNECT TO ORACLE(PATH=&GOLD PRESERVE_COMMENTS);*/
  /*				CREATE TABLE Practioner AS*/
  /*				SELECT * FROM CONNECTION TO ORACLE*/
  /*				( */
  /*        SELECT prctr.prctr_id AS practitioner_id,*/
  ...
  *SASDOC--------------------------------------------------------------------------
  ...
  /*			%PARTICIPANT_EXCLUSIONS(TBL_NAME_IN = &ORA_TMP..CLAIMS_PULL_&INITIATIVE_ID._&ADJ_ENGINE.);*/
