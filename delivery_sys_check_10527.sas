...
+-----------------------------------------------------------------------------------------------------------HEADER*/
%MACRO DELIVERY_SYS_CHECK_10527(INITIATIVE_ID,HERCULES);
...
/*	   %LET RETAIL_DELVRY_CD = %STR(AND PHMCY.NABP_CODE_6 IN('482663','146603','032664','012929','398095','459822','032691','147389','458303','100229'));*/
	   %LET RETAIL_DELVRY_CD = %STR(AND CLAIM.NABP_CODE_6 IN('482663','146603','032664','012929','398095','459822','032691','147389','458303','100229'));
...
/*	%LET MAIL_DELVRY_CD = %STR(AND PHMCY.NABP_CODE_6 NOT IN('482663','146603','032664','012929','398095','459822','032691','147389','458303','100229'));*/
	%LET MAIL_DELVRY_CD = %STR(AND CLAIM.NABP_CODE_6 NOT IN('482663','146603','032664','012929','398095','459822','032691','147389','458303','100229'));
...
/*					 END AS DELIVERY_SYSTEM );*/
	...
	%LET EDW_DELIVERY_SYSTEM = %STR( CASE WHEN CLAIM.NABP_CODE_6 IN ('482663','146603','032664','012929','398095','459822','032691','147389','458303','100229') 
					      THEN 'RETAIL'
					      WHEN CLAIM.NABP_CODE_6 NOT IN ('482663','146603','032664','012929','398095','459822','032691','147389','458303','100229')
					      THEN 'MAIL'
					 END AS DELIVERY_SYSTEM );

/*	   %LET CREATE_DELIVERY_SYSTEM_CD_RE = %STR(CASE WHEN PHMCY.MAIL_ORDR_CODE='Y' THEN '2'   */
/*							 ELSE '3'*/
...
%MEND DELIVERY_SYS_CHECK_10527;
%DELIVERY_SYS_CHECK_10527(&INITIATIVE_ID,&HERCULES);
