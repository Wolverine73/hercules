...
DATA _NULL_;
SET WORK.ALIGN;
FILE "/DATA/sas&sysmode.1/hercules/gen_utilities/sas/cee_temp_dataset/eoms_print_hercules_disposition_&datevar.&timevar..dat" dlm='|' dsd;
PUT
SOURCE :$5.  
OPPORTUNITY_ID :$10.
CEE_CHANNEL_CODE :$5. 
...
FILE "/DATA/sas&sysmode.1/hercules/gen_utilities/sas/cee_temp_dataset/eoms_print_hercules_disposition_&datevar.&timevar..ctl" dlm='|' dsd;
...
%LET SOURCE_DIR=/DATA/sas&sysmode.1/hercules/gen_utilities/sas/cee_temp_dataset/;
...
/*	THIS MACRO IS DISCONTINUED AND WILL BE IN THE VERSIONS FOLDER	*/
